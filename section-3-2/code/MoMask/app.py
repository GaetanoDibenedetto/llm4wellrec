...
<h3> Description </h3>
<p>
🔥 This space presents an interactive demo for <a href='https://ericguo5513.github.io/momask/' target='_blank'><b>MoMask</b></a>, a method for text-to-motion generation!!! It generates human motions (skeletal animations) based on your descriptions. 
</p>
<p>
🚀 You could try the provided examples first. Modify your text prompt or motion length to get better results.
</p>
<p>
🚀 We provide a link to download the generated human skeletal motion in <b>BVH</b> file format, compatible with CG software such as Blender!!! 
</p>
<p>
🚀 The demo is now running smoothly on a CPU. No GPU is required!!! 
</p>
<p>
...
def generate(
    ...
    for r in range(repeat_times):
        ...
        for k, (caption, joint_data)  in enumerate(zip(captions, data)):
            ...
            save_path = pjoin(animation_path, "sample_repeat%d_%d.gif"%(r, ruid))
            if use_ik:
                print("Using IK")
        ...
        data_unit = {
            "url": pjoin(animation_path, "sample_repeat%d_%d.gif"%(r, ruid))
            }
