...
if __name__ == '__main__':
    ...
    opt.log_dir = pjoin('./log/res/finetuning/20_ep/', opt.dataset_name, opt.name)
    ...
    train_loader = DataLoader(train_dataset, batch_size=opt.batch_size, num_workers=4, shuffle=True, drop_last=False)
    val_loader = DataLoader(val_dataset, batch_size=opt.batch_size, num_workers=4, shuffle=True, drop_last=False)

    # eval_val_loader, _ = get_dataset_motion_loader(dataset_opt_path, 32, 'val', device=opt.device)
    eval_val_loader, _ = get_dataset_motion_loader(dataset_opt_path, 10, 'val', device=opt.device)
