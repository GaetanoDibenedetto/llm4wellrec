...
**Evaluating Generative Text-to-Motion for Occupational Wellbeing Recommender Systems** 
by *Gaetano Dibenedetto, Stefano Labianca, Andrea Romano, and Pasquale Lops*. 
...
3. **Example Annotations:**
   * *Description 1 (Direct):* "A worker lifting a box from the floor."
   * *Description 2 (Safety-focused):* "A person safely lifting a load with a straight spine."
   * *Description 3 (Metric-based):* "Worker lifting a 15kg load close to the body core."
   * *Description 4 (Action-oriented):* "Bending the knees to lift an object from the ground."
