...
def load_trans_model(model_opt, opt, which_model):
    ...
    # print(f"trans model: {list(ckpt[model_key].keys())}")
...
def load_res_model(res_opt, vq_opt, opt):
    ...
    ckpt = torch.load(
        pjoin(
            res_opt.checkpoints_dir, 
            res_opt.dataset_name, 
            res_opt.name, 
            'model', 
            'net_best_fid.tar'
        ),
    ...
    # print(f"res model: {list(ckpt['res_transformer'].keys())}")
...
# vq_opt_path = pjoin("./checkpoints/t2m/rvq_retraining_full_new_annotation", 'opt.txt')
if __name__ == '__main__':
    ...
    # opt.dataset_name = "t2m" | "kit"
    dim_pose = 251 if opt.dataset_name == 'kit' else 263

    # out_dir = pjoin(opt.check)
    # opt.checkpoints_dir = "./checkpoints"
    # opt.name -> Nome del modello
    ...
    ######Loading RVQ######
    #######################
    # model_opt.vq_name -> Nome del modello RVQ
    ...
    #################################
    # opt.res_name -> Nome del Residual Transformer
