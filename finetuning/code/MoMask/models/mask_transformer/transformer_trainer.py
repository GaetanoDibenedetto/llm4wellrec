...
class MaskTransformerTrainer:
    ...
    def resume(self, model_dir):
        ...
        try:
            ...
            self.opt_t2m_transformer.param_groups[0]['capturable'] = True
    ...
    def train(self, train_loader, val_loader, eval_val_loader, eval_wrapper, plot_eval):
        ...
        best_fid, best_top1, best_top2, best_top3, best_matching, writer = evaluation_mask_transformer(
        ...
        while epoch < self.opt.max_epoch:
            ...
            best_fid,  best_top1, best_top2, best_top3, best_matching, writer = evaluation_mask_transformer(
                ...
                best_div=None, best_top1=best_top1, best_top2=best_top2, best_top3=best_top3,
...
class ResidualTransformerTrainer:
    ...
    def resume(self, model_dir):
        ...
        total_it = checkpoint.get('total_it')
        if total_it is None:
            return checkpoint['ep'], 0
        else:
            return checkpoint['ep'], total_it
    ...
    def train(self, train_loader, val_loader, eval_val_loader, eval_wrapper, plot_eval):
        ...
        if self.opt.is_continue:
            ...
            model_dir = pjoin(self.opt.model_dir, 'net_best_fid.tar')  # TODO
            epoch, it = self.resume(model_dir)
            print("Load model epoch:%d iterations:%d"%(epoch, it))
        ...
        best_fid, best_top1, best_top2, best_top3, best_matching, writer = evaluation_res_transformer(
        ...
        while epoch < self.opt.max_epoch:
            ...
            best_fid,  best_top1, best_top2, best_top3, best_matching, writer = evaluation_res_transformer(
                ...
                best_div=100, best_top1=best_top1, best_top2=best_top2, best_top3=best_top3,
                best_matching=best_matching, eval_wrapper=eval_wrapper,
                plot_func=plot_eval, save_ckpt=True, save_anim=(epoch%self.opt.eval_every_e==0)
            )